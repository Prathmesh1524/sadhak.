import React from 'react'
  ...
  return (
    ...
    <div className="relative py-3 sm:max-w-xl sm:mx-auto">
      <div className="relative px-4 py-10 bg-slate-300 mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div className="max-w-md mx-auto text-white">
          <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input
                className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-slate-100 text-black                                           focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                type="text"
                id="fullname"
              />
            </div>
          ...
          <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              <label
                className="font-semibold text-sm tex-gray-900  pb-1 block"
                htmlFor="gender"
              >
                Gender
              </label>
          ...
          <div className="flex justify-center items-center">
            <div>
              <button className="flex items-center justify-center py-2 px-20 bg-white hovbg-slate-100 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                <svg
                  viewBox="0 0 24 24"
                  height="25"
                  width="25"
              ...
              <button className="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mt-4">
               <img className='reverse' src="GitHub-Symbol.png" alt="" />
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <a
              className="text-xs text-gray-900 uppercase dark:text-gray-400 hover:underline"
              href="#"
            >
